...
describe('Service', () => {
    ...
    it("filters by date", async () => {
        ...
        expect(await serv.filterDate(Date.parse("2022-2-23")))
            .toStrictEqual([
                {
                    id: 100001,
                    date: 1645563600000,
    ...
    it("filters by description", async () => {
        ...
        expect(await serv.filterDescript('create'))
            .toStrictEqual([
                {
                    id: 100001,
                    date: 1645563600000,
    ...
    it("filters by status", async () => {
        ...
        expect(await serv.filterStatus('openned'))
            .toStrictEqual([
                {
                    id: 100001,
                    date: 1645563600000,
    ...
    it("filters by tag", async () => {
        ...
        expect(await serv.filterTag("yellow"))
            .toStrictEqual([
                {
                    id: 100003,
                    date: 1645736400000,
